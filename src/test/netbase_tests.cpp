...
{
    BOOST_CHECK(TestSplitHost("www.familycoincore.org", "www.familycoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.familycoincore.org]", "www.familycoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.familycoincore.org:80", "www.familycoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.familycoincore.org]:80", "www.familycoincore.org", 80));
