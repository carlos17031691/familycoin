...
#ifndef FAMILYCOIN_TEST_SCRIPTNUM10_H
#define FAMILYCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Familycoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // FAMILYCOIN_TEST_BIGNUM_H
