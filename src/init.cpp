...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/familycoin-project/familycoin>";
    const std::string URL_WEBSITE = "<https://familycoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Familycoin version %s\n", FormatFullVersion());
}
