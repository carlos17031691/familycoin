...
#ifndef FAMILYCOIN_INTERFACES_NODE_H
#define FAMILYCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a familycoin node (familycoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // FAMILYCOIN_INTERFACES_NODE_H
