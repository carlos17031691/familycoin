...
#ifndef FAMILYCOIN_WALLET_WALLET_H
#define FAMILYCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this familycoin node, and set to 0 for transactions that were created
...
#endif // FAMILYCOIN_WALLET_WALLET_H
