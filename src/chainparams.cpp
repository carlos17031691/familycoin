...
{
    const char* pszTimestamp = "25/Oct/2021 - Se crea la criptomoneda FamilyCoin";
    const CScript genesisOutputScript = CScript() << ParseHex("432184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1635211129, 2000564814, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x47ae8dc3729a6d2e99388a08f13e7392e855a71d6f2181d67c8ef0598e2f1991"));
        assert(genesis.hashMerkleRoot == uint256S("0xe2424ed42223766706a1fefd9f8ead82cb48ef509ed8befc729981c131e3d705"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("172.16.1.20", "172.16.1.20", true));
        // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        // vSeeds.push_back(CDNSSeedData("familycointools.com", "dnsseed.familycointools.com"));
        // vSeeds.push_back(CDNSSeedData("familycoinpool.org", "dnsseed.familycoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x47ae8dc3729a6d2e99388a08f13e7392e855a71d6f2181d67c8ef0598e2f1991"))
        ...
        chainTxData = ChainTxData{
            ...
            1635211129, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1635211129, 2515837, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6d12e4f634b553685e3411888216eda9a9e130d9e15d46300f30490f6f51ea9e"));
        assert(genesis.hashMerkleRoot == uint256S("0xe2424ed42223766706a1fefd9f8ead82cb48ef509ed8befc729981c131e3d705"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("172.16.1.20", "172.16.1.20"));
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.familycoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x6d12e4f634b553685e3411888216eda9a9e130d9e15d46300f30490f6f51ea9e")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1635211129, 2, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb2db92a14b7440080952dfef94809912fc64e77405b4c615efa817a2d1d3e164"));
        assert(genesis.hashMerkleRoot == uint256S("0xe2424ed42223766706a1fefd9f8ead82cb48ef509ed8befc729981c131e3d705"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xb2db92a14b7440080952dfef94809912fc64e77405b4c615efa817a2d1d3e164"))
        };
