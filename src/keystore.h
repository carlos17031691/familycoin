...
#ifndef FAMILYCOIN_KEYSTORE_H
#define FAMILYCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/familycoin/bips/blob/master/bip-0013.mediawiki
