 ...
 */
#ifndef FAMILYCOIN_UTIL_H
#define FAMILYCOIN_UTIL_H
...
extern const char * const FAMILYCOIN_CONF_FILENAME;
extern const char * const FAMILYCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("familycoin-%s", name);
