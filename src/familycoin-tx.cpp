...
static void SetupFamilycoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " familycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  familycoin-tx [options] <hex-tx> [commands]  Update hex-encoded familycoin transaction\n" +
            "or:     familycoin-tx [options] -create [commands]   Create hex-encoded familycoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded familycoin transaction
