...
#ifndef FAMILYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define FAMILYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // FAMILYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
