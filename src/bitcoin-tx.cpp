...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s familycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  familycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded familycoin transaction") + "\n" +
              "  familycoin-tx [options] -create [commands]   " + _("Create hex-encoded familycoin transaction") + "\n" +
              "\n";
