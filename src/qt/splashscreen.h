...
#ifndef FAMILYCOIN_QT_SPLASHSCREEN_H
#define FAMILYCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Familycoin Core initialization
...
#endif // FAMILYCOIN_QT_SPLASHSCREEN_H
