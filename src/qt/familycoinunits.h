...
#ifndef FAMILYCOIN_QT_FAMILYCOINUNITS_H
#define FAMILYCOIN_QT_FAMILYCOINUNITS_H
...
/** Familycoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FamilycoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FamilycoinUnits(QObject *parent);

    /** Familycoin units.
      @note Source: https://en.familycoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FAMILY,
...
typedef FamilycoinUnits::Unit FamilycoinUnit;

#endif // FAMILYCOIN_QT_FAMILYCOINUNITS_H
