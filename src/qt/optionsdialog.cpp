    ...
    mapper(0)
{
    ...
    ui->familycoinAtStartup->setToolTip(ui->familycoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->familycoinAtStartup->setText(ui->familycoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openFamilycoinConfButton->setToolTip(ui->openFamilycoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new FamilycoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->familycoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openFamilycoinConfButton_clicked()
{
