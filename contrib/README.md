...
Contains files used to package familycoind/familycoin-qt
for Debian-based Linux systems. If you compile familycoind/familycoin-qt yourself, there are some useful files here.
...
### [RPM](/contrib/rpm) ###
RPM spec file for building familycoin-core on RPM based distributions
