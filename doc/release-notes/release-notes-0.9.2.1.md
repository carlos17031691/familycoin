Familycoin Core version 0.9.2.1 is now available from:

  https://familycoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 FAMILY to 0.01 FAMILY
...
- Fix "Start familycoin on system login"
