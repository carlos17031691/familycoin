Familycoin Core version 0.10.4 is now available from:

  <https://familycoin.org/bin/familycoin-core-0.10.4/>
...
- #6953 `43c2789` Split familycoin-tx into its own package
- #6953 `dfe0d4d` Include familycoin-tx binary on Debian/Ubuntu
