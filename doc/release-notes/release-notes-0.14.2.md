Familycoin Core version 0.14.2 is now available from:
  ...
  <https://familycoin.org/bin/familycoin-core-0.14.2/>
...
(in Familycoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Familycoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate familycoin-config.h as necessary (theuni)
