Familycoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/familycoin/files/Familycoin/familycoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Familycoin
...
New/changed settings (command-line or familycoin.conf file)
--------------------------------------------------------
