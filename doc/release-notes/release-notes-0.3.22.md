Download URL: https://sourceforge.net/projects/familycoin/files/Familycoin/familycoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 FAMILY fee schedule (users still pay 0.01 FAMILY per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #familycoin00 - #familycoin99
