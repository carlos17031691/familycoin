Familycoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/familycoin/files/Familycoin/familycoin-0.5.4/
...
http://gitorious.org/familycoin/familycoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Familycoin-Qt notifications under Growl 1.3.
Increase required age of Familycoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFamilycoin properly when installing Familycoin-Qt over it. (Windows)
