Familycoin Core version 0.13.2 is now available from:
  ...
  <https://familycoin.org/bin/familycoin-core-0.13.2/>
...
- #8908 `4a974b2` Update familycoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow familycoin-tx to create v2 transactions (btcdrak)
