Familycoin Core version 0.9.4 is now available from:

  https://familycoin.org/bin/0.9.4/
...
this update is incompatible with the Familycoin system and could lead to consensus
forks.

Familycoin Core released binaries from https://familycoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~familycoin/+archive/ubuntu/familycoin
- A third-party or self-compiled Familycoin Core

upgrade to Familycoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
