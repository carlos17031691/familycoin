...
This document provides guidelines for internationalization of the Familycoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `familycoin_en.ts` remains unchanged.
