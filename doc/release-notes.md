Familycoin Core version 0.17.1 is now available from:

  <https://familycoincore.org/bin/familycoin-core-0.17.1/>
...
When familycoin is configured with the `-deprecatedrpc=accounts` setting, specifying
...
- #14698 `ec71f06` Add familycoin-tx.exe into Windows installer (ken2812221)
