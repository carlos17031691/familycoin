...
"""Verify that starting familycoin with -h works as expected."""

from test_framework.test_framework import FamilycoinTestFramework
from test_framework.util import assert_equal

class HelpTest(FamilycoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start familycoin with -h for help text")
        ...
        self.log.info("Start familycoin with -version for version information")
        ...
        self.log.info("Start familycoind with -fakearg to make sure it does not start")
