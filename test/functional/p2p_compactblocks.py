...
# TestP2PConn: A peer we use to send messages to familycoind, and store responses.
...
class CompactBlocksTest(FamilycoinTestFramework):
    ...
    # This test actually causes familycoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that familycoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for familycoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # familycoind will not send blocktxn responses for blocks whose height is
